---
layout: post
title: "Medição de corrente com shunt usando OPAMP + ADC no STM32G4"
date: 2026-01-09 09:10:00 -0300
categories: ["Tutoriais"]
tags: ["KEPR", "STM32G4", "STM32G484", "OPAMP", "ADC", "Shunt", "Medição de corrente", "Instrumentação"]
description: "Como medir corrente no KEPR com shunt e os OPAMPs internos (OPAMP1..3) do STM32G484, lendo via ADC e convertendo ADC→tensão→corrente."
keywords: ["STM32G484", "OPAMP", "ADC", "VOPAMP", "shunt", "medição de corrente", "instrumentação", "CubeMX", "KEPR"]
---
